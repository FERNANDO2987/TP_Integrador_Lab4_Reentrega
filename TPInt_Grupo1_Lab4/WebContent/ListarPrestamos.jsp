...
<body>
		...
		<div class="row mb-4">
			<div class="col-12 col-md-6 search-container">
				<input type="text" id="searchInput" class="form-control"
					placeholder="Buscar prestamo..." onkeyup="filterTable()">
			</div>
		</div>
		<%
						...
						<td>
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right"
									onclick="return confirm('¿Quiere aprobar el prestamo?');">
									<a class="dropdown-item" href="#"> <i class="fas fa-check"></i>
										Aprobar
									</a> <a class="dropdown-item text-danger" href="#"
										onclick="return confirm('¿Quiere rechazar el prestamo?');">
	...
	<script>
		...
		// Funciï¿½n para filtrar la tabla en tiempo real
