...
.logout-icon {
	position: relative;
	/* Esto permite que el tooltip se posicione relativo a este div */
}
...
<body class="bg-gray-100">
	<%
		...
		String nombreUsuario = (usuario.getUsuario() != null)
				? usuario.getUsuario()
				: "Usuario desconocido";
	%>
	...
	<nav
		...
		<div class="logout-icon">
			<a href="servletLogout?id=<%=usuario.getId()%>"
				...
				Logout </a> <span class="tooltip" id="tooltip">Salir</span>
		</div>
	</nav>
  ...
  <!-- Contenido principal -->
	...
	<div class="sidebar" id="sidebar">
		...
		<ul class="space-y-2">
			<li><a class="menu2-icon hover:text-blue-500 block p-2" href="#"
				onclick="cargarPagina('inicio')">Inicio</a></li>
			<li><a class="menu2-icon hover:text-blue-500 block p-2" href="#"
				onclick="cargarPagina('prestamos')">Préstamos</a></li>
			<li><a class="menu2-icon hover:text-blue-500 block p-2" href="#"
				onclick="cargarPagina('listarUsuarios')">Listar Usuarios</a></li>
			<li><a class="menu2-icon hover:text-blue-500 block p-2" href="#"
				onclick="cargarPagina('listarClientes')">Listar Clientes</a></li>
			<li><a class="menu2-icon hover:text-blue-500 block p-2" href="#"
				onclick="cargarPagina('historialPrestamos')">Historial Préstamos</a></li>
		</ul>
	</div>
	...
	<script>
		...
		function toggleSidebar() {
			...
			var contenidoPrincipal = document
