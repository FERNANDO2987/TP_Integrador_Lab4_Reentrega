...
%>
    ...
    <a class="dropdown-item flex items-center px-8 py-2 text-sm text-gray-700 hover:bg-gray-100" href="ModificarCliente.jsp?id=<%= cliente.getId() %>">
        <i class="fas fa-edit mr-2"></i> <!-- �cono con margen a la derecha -->
        Modificar
    </a>  
    <!-- Opci�n para Eliminar -->
    <a href="servletEliminarCliente?id=<%= cliente.getId() %>" class="dropdown-item flex items-center px-4 py-2 text-sm text-red-500 hover:bg-red-100" onclick="return confirm('�Est�s seguro de que deseas eliminar este cliente?');">
        <i class="fas fa-trash-alt mr-2"></i> <!-- �cono con margen a la derecha -->
        Eliminar
    </a> 
</div>
