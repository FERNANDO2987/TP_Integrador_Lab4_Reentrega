...
<body class="h-screen flex items-center justify-center bg-gradient-to-r from-gray-900 to-gray-800 text-gray-100">  
    ...
    <div class="w-full max-w-md bg-gray-850 p-8 rounded-lg shadow-2xl border border-gray-700">  
        <h2 class="text-center text-3xl font-extrabold mb-6">Iniciar Sesión</h2>  
        ...
        <form action="servletLogin" method="post" class="space-y-4">  
            ...
            <div>  
                ...
                <div class="relative">  
                    <input type="password" id="contrasenia" name="contrasenia" class="mt-1 w-full p-3 rounded bg-gray-700 text-white border border-gray-600 focus:ring focus:ring-blue-500 focus:border-blue-500" placeholder="Ingresa tu contraseña" required>  
                    <img id="eye-icon" src="https://cdn-icons-png.flaticon.com/128/10812/10812267.png" alt="Toggle password visibility" class="absolute right-3 top-3 eye-icon" onclick="togglePasswordVisibility()" width="20" height="20"/>  
                </div>  
            </div>  
