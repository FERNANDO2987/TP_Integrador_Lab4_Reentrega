...
.login-container {
    ...
    width: 100%;
    max-width: 400px; /* M�xima anchura del formulario */
}
...
input[type="submit"] {
    width: 100%; /* Aseguramos que el bot�n ocupe todo el ancho */
}
            ...
            <div class="col-md-12">  
                ...
                <form action="servletLogin" method="post">   
                    ...
                    <div class="form-group">  
                        ...
                        <input type="password" class="form-control" id="contrasenia" name="contrasenia" placeholder="Ingresa tu contrase�a">  
                    </div>  
