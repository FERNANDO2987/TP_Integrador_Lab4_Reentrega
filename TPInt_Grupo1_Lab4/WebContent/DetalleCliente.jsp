...
<body>
	<div class="container">
		<div class="row" style="padding: 2rem;">
			<h1>ROBERTO PEREZ 21-30405566-5</h1>
		</div>
		<div class="row" style="padding: 0rem 1rem;">
			<div class="col-md-6">
				<div class="card" style="height: 25rem;">
					...
					<div class="card-body">
						...
						<p>
							<strong>Nombre:</strong> aaa
						</p>
						<p>
							<strong>Apellido:</strong> bbb
						</p>
						<p>
							<strong>DNI:</strong> 20345678
						</p>
						<p>
							<strong>CUIL:</strong> 21203456785
						</p>
						<p>
							<strong>Sexo:</strong> xx
						</p>
						<p>
							<strong>Fecha de nacimiento:</strong> aaa
						</p>
						<p>
							<strong>Nacionalidad:</strong> aaa
						</p>
					</div>
				</div>
			</div>
			<div class="col-md-6">
				<div class="card mb-3" style="height: 13rem;">
					...
					<div class="card-body">
						<p>
							<strong>Dirección:</strong> aaa
						</p>
						<p>
							<strong>Localidad:</strong> aaa
						</p>
						<p>
							<strong>Provincia:</strong> aaa
						</p>
					</div>
				</div>
			...
			<div class="card w-100">
				...
				<div
					...
					<div class="flex-grow-1 px-2">
						<p>
							<strong>Usuario:</strong> Usuario123
						</p>
					</div>
					<div class="flex-grow-1 px-2">
						<p>
		...
		<div class="row d-flex justify-content-between" style="padding: 2rem;">
			<div class="d-flex">
				<a href="#" class="btn btn-danger">Volver</a> <a href="#"
					class="btn btn-primary mx-3">Modificar Detalles</a>
			</div>
